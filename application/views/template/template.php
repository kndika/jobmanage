...
//if(!empty($this->session->user_userId)){
 // redirect(base_url());
 // }
 // else{
  //  redirect(base_url());
...
?>
  ...
  <body class="nav-md " id="input-group">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
       
          <?php   $this->load->view('template/let_panal'); ?>
        </div>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        ...
                        <span>
                          <span><?php echo $this->session->userId?></span>
      ...
      <?php   $this->load->view('template/foter');?>
